...
use crate::absorb::absorb_memory;
use crate::instincts::{apply_instincts, check_ghost_replacement, load_instincts};
use crate::dreaming::{dream_cycle, DreamCycleResult};
use crate::decay::{
    apply_recall_boost, classify_health, compute_pattern_decay, is_dead, EDGE_DECAY_RATE,
};
use crate::graph::ConnectionGraph;
use crate::interference::{now_unix, parse_datetime_approx, resolve_interference};
use crate::pca::PcaTransform;
use crate::persistence::{load_edges, load_memories, save_edge, save_pca_state, load_pca_state};
use crate::substrate::HopfieldSubstrate;
use crate::types::{
    ActivatedMemory, BrainEdge, BrainMemory, ContradictionPair, QueryResult,
    StatsResult, RAW_DIM,
};

#[cfg(feature = "evolution")]
use crate::types::EvolutionStatsResult;
...
pub struct Brain {
    ...
    pub pca: PcaTransform,
    pub substrate: HopfieldSubstrate,
    pub graph: ConnectionGraph,
    pub conn: Option<Connection>,
    pub dream_cycle_count: u64,
...
impl Brain {
    ...
    pub fn init(&mut self, db_path: &str, data_dir: Option<&str>) -> Result<String, String> {
    ...
    pub fn absorb_new(&mut self, mut memory: BrainMemory) {
    ...
    pub fn decay_tick(&mut self, ticks: u32) {
    ...
    #[cfg(feature = "evolution")]
    pub fn evolution_feedback(&mut self, memory_ids: Vec<i64>, edge_pairs: Vec<[i64; 2]>, useful: bool) {
    ...
    #[cfg(feature = "evolution")]
    pub fn evolution_train(&mut self) -> u32 {
    ...
    #[cfg(feature = "evolution")]
    pub fn evolution_stats(&self) -> EvolutionStatsResult {
